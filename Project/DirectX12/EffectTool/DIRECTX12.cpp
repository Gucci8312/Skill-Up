...
// 初期化
bool DIRECTX12::Init(HWND _hWnd, int _Width, int _Height)
{
#ifdef DEBUG
	EnableDebugLayer();
#endif
...
// リソースバリア
void DIRECTX12::BarrierResouce(ID3D12Resource* _Resouce, D3D12_RESOURCE_STATES _BeforeState, D3D12_RESOURCE_STATES _AfterState)
{
	// 設定
